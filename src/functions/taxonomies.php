 ...
 * @param int $taxonomy the taxonomy to fetch the term, defaults to 'category'.
 ...
 */
function lean_get_post_term( $post_id = 0, $taxonomy = 'category', $index = 0 ) {
 ...
 */
function lean_get_post_term_name( $post_id = 0, $taxonomy = 'category', $index = 0 ) {
 ...
 */
function lean_get_posts_by_term( $term_id, $taxonomy = 'category', $limit = 20 ) {
 ...
 */
function lean_get_post_by_term( $term_id, $taxonomy = 'category' ) {
